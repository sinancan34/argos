...
> Drop this file + AGENT_DIRECTIVES.md into any project root.
> If the project already has a CLAUDE.md, this file extends it.
> If not, this file acts as the primary directive file.
